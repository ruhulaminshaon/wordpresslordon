...
$this->add_custom_javascript("
	...
	jQuery(document).ready(function(){
		...
		fn_step = jQuery('div#step-available').beautifully_steps({
			...
			steps : [
				{step: 1, text: '".__('Store Details', 'vendor-setup-wizard')."', description: '".get_option('vendor_setup_wizard_store_description', 'Your Store Details')."'},				
				{step: 2, text: '".__('Store payment', 'vendor-setup-wizard')."', description: '".get_option('vendor_setup_wizard_withdraw_description', 'Basics of your store')."'},
				{step: 3, text: '".__('Ready', 'vendor-setup-wizard')."', description: '".get_option('vendor_setup_wizard_ready_description', 'Ready')."'}
			],
			step_style : {
